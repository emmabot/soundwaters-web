...
export default function FilterPanel({
  ...
  return (
    <>
      ...
      <button
        onClick={onToggle}
        className="glass pointer-events-auto fixed left-4 top-[calc(var(--nav-mobile-offset)+10px)] z-30 flex h-12 w-12 items-center justify-center rounded-xl shadow-lg transition-all hover:scale-105 hover:shadow-xl sm:left-5 sm:top-[76px]"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="pointer-events-auto absolute left-0 top-[var(--nav-mobile-offset)] z-20 flex h-[calc(100%-var(--nav-mobile-offset))] w-full flex-col overflow-hidden rounded-r-2xl shadow-2xl sm:top-0 sm:h-full sm:w-[350px]"
          >
