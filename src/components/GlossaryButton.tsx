  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="pointer-events-auto absolute left-0 top-[var(--nav-mobile-offset)] z-40 flex h-[calc(100%-var(--nav-mobile-offset))] max-h-[85vh] sm:max-h-full sm:top-0 sm:h-full w-full flex-col overflow-hidden rounded-r-2xl shadow-2xl sm:w-[360px]"
        drag="x"
